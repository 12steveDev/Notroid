...
const PrivApp = {
    installApps(){
        console.groupCollapsed(`[PrivApp][installApps]`);
        ...
        if (!FileSystem._goTo("", "/system/framework/framework-res.npk")){
            FileSystem._installApp({
                package: "notroid",
                name: "framework-res",
                icon: "https://placehold.co/150x150/EEEEEE/2266DD?text=F-RES",
                versionCode: 1,
                permissions: [],
                res: {
                    layouts: {
                        "hw": {type:"layout",padding:"5px",child:[
                            {type:"text",id:"txt",fg:"black",text:'${["NOTROID_RES", "string", "hw"]}'}, // lo peor es que sí funciona
                            {type:"button",id:"btn",text:"Borrar 'androidx.*' y 'android.support.*'",onclick:[["ELEM_SET_TEXT", ["GET_ELEM_BY_ID", "txt"], "¡Bravo!👏👏👏"],["ELEM_SET_TEXT", ["GET_ELEM_BY_ID", "btn"], "hiciste lo correcto hijo✅✅..."]]}
                        ]}
                    },
                    strings: {
                        "hw": "Hola Mundo desde framework-res.npk!" // el mejor hello world de mi vida
                    },
                },
                activities: {},
                flags:["FRAMEWORK_RES_APP"]
            });
        }
        console.groupEnd();
    }
